...
if ( function_exists('register_sidebar') ) {
    ...
    if(ale_get_option('leftsidebarcustom') == 1){
        register_sidebar(array(
            'name' => 'Left Sidebar Custom',
            'id' => 'left-sidebar-custom',
            'description' => 'Appears as the left sidebar on Custom pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h2 class="widgettitle">',
            'after_title' => '</h2>',
    ...
    if(ale_get_option('rightsidebarcustom')==1){
        register_sidebar(array(
            ...
            'id' => 'right-sidebar-custom',
            'description' => 'Appears as the right sidebar on Custom pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h2 class="widgettitle">',
            'after_title' => '</h2>',
    ...
    register_sidebar(array(
        'name' => 'Right About & Contact Sidebar',
        'id' => 'right-sidebar-template',
        'description' => 'Appears as the right sidebar on About and Contact pages',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h2 class="widgettitle">',
        'after_title' => '</h2>',
    ...
    register_sidebar(array(
        'name' => 'Left About & Contact Sidebar',
        'id' => 'left-sidebar-template',
        'description' => 'Appears as the left sidebar on About and Contact pages',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h2 class="widgettitle">',
        'after_title' => '</h2>',
    ...
    if(is_plugin_active( 'woocommerce/woocommerce.php')) {
        register_sidebar(array(
            ...
            'description' => 'Appears as the left sidebar on Shop pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h2 class="widgettitle">',
            'after_title' => '</h2>',
        ...
        register_sidebar(array(
            ...
            'description' => 'Appears as the right sidebar on Shop pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h2 class="widgettitle">',
            'after_title' => '</h2>',
    ...
    register_sidebar(array(
        ...
        'description' => 'Appears as the left sidebar on Home page',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h2 class="widgettitle">',
        'after_title' => '</h2>',
