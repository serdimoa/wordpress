	...
	$.fn.aletheme_edit_slider = function(){
		...
		$(this).each(function(){
			...
			$('#aletheme-save-slider-button').click(function(e){
				...
				button.addClass('button-primary-disabled').delay(1500).queue(function(){
                    $(this).removeClass("button-primary-disabled").dequeue();
                });
				loading.css('visibility', 'visible').delay(1500).queue(function(){
